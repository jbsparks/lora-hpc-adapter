...
def main() -> None:
    ...
    baseline.add_argument("--max-new-tokens", type=int, default=256)
    ...
    tuned.add_argument("--max-new-tokens", type=int, default=256)
    ...
    judge.add_argument("--use-chat-template", action="store_true")
    ...
    demo.add_argument("--max-new-tokens", type=int, default=256)
